#ifndef IS_VENDOR_CONFIG_RSX_V12_H
#define IS_VENDOR_CONFIG_RSX_V12_H
...
#if !defined(CONFIG_USE_SIGNED_BINARY) || defined(CONFIG_SEC_FACTORY)
#define USE_SENSOR_DEBUG
#endif

#endif /* IS_VENDOR_CONFIG_RSX_V12_H */
